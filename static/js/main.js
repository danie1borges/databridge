...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderSingleResult(data) {
        ...
        if (data.app_cliente) {
            ...
            if (!bestName && data.app_cliente.nome) bestName = data.app_cliente.nome;
            if (!bestEmail && data.app_cliente.email) { bestEmail = data.app_cliente.email; bestEmailSrc = 'Portal Cliente'; }
            if (!bestPhone && data.app_cliente.celular) { bestPhone = data.app_cliente.celular; bestPhoneSrc = 'Portal Cliente'; }
            if (!bestAddress && data.app_cliente.endereco) { bestAddress = data.app_cliente.endereco; bestAddressSrc = 'Portal Cliente'; }
        }
                ...
                <div class="client-profile-info">
                    ...
                    <div class="presence-strip">
                        ${[
                            ...
                            { name: 'Portal Cliente', icon: 'fa-users', color: '#3B82F6', found: !!data.app_cliente },
